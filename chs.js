...
var cnItems = {
    ...
    'Grow your first hive empress': '首次成长出主巢女皇',
    'queen of queens': '王中王，皇中皇',
    'wu zetian': '武曌，武则天',
    'matriarchy': '母系社会',
    'Grow your first neuroprophet': '首次成长出神经元先知',
    '1. collect larvae': '1、产生幼虫',
    '2. ?': '2、？',
    '3. prophet': '3、先知',
    'Grow your first hive neuron': '首次成长出主巢神经元',
    'neurogenesis': '神经元发生',
    'new neurons': '新的神经元',
    'neuronerd': '神经元怪人',
    'Grow your first neural cluster': '首次成长出神经元簇',
    'nucleus': '核心',
    'ganglion': '神经节',
    'cluster-something': '聚集成簇',
    'Grow your first hive network': '首次成长出主巢网络',
    'arpanet': '阿帕网',
    'backpropagation': '反向传播',
    'nydus': '虫群坑道',
    'Grow your first lesser hive mind': '首次成长出次级主巢心智',
    'do you mind?': '您很有兴致？',
    'lesser is morer': '虽次亦佳',
    'lord have mercy': '此即主之行至',
    'Grow your first hive mind': '首次成长出主巢心智',
    'one of us': '合而为一',
    'groupthink': '集体审议',
    'swarm intelligence': '群体智慧',
    'Grow your first arch-mind': '首次成长出高级心智',
    'ante meridiem': '高尚心灵',
    'archery': '位高权重',
    'cerebration time': '脑虫庆典',
    'Grow your first overmind': '首次成长出主宰',
    ...
    'Grow your first overmind II': '首次成长出主宰 II',
    'transcendent thought': '思维超越',
    'Grow your first overmind III': '首次成长出主宰 III',
    'Grow your first overmind IV': '首次成长出主宰 IV',
    'Grow your first overmind V': '首次成长出主宰 V',
    'Grow your first overmind VI': '首次成长出主宰 VI',
    'Ascend once': '飞升1次',
...
var cnRegReplace = new Map([
    ...
    [/^Hatch (.+) drones$/, '孵化$1单位工蜂'],
    [/^Build (.+) nests$/, '建造$1单位虫巢'],
    [/^Hatch (.+) greater queens$/, '孵化$1单位大虫后'],
    [/^Build (.+) hives$/, '建造$1单位主巢'],
    [/^Hatch (.+) hive queens$/, '孵化$1单位主巢虫后'],
    [/^Hatch (.+) queens$/, '孵化$1单位虫后'],
    [/^Grow (.+) hive empresses$/, '成长出$1单位主巢女皇'],
    [/^Grow (.+) neuroprophets$/, '成长出$1单位神经元先知'],
    [/^Grow (.+) hive neurons$/, '成长出$1单位主巢神经元'],
    [/^Grow (.+) neural clusters$/, '成长出$1单位神经元簇'],
    [/^Grow (.+) hive networks$/, '成长出$1单位主巢网络'],
    [/^Grow (.+) lesser hive minds$/, '成长出$1单位次级主巢心智'],
    [/^Grow (.+) hive minds$/, '成长出$1单位主巢心智'],
    [/^Grow (.+) arch-minds$/, '成长出$1单位高级心智'],
    [/^Grow (.+) overminds$/, '成长出$1单位主宰'],
    [/^Grow (.+) overmind IIs$/, '成长出$1单位主宰 II'],
    [/^Grow (.+) overmind IIIs$/, '成长出$1单位主宰 III'],
    [/^Grow (.+) overmind IVs$/, '成长出$1单位主宰 IV'],
    [/^Grow (.+) overmind Vs$/, '成长出$1单位主宰 V'],
    [/^Grow (.+) overmind VIs$/, '成长出$1单位主宰 VI'],
    [/^Ascend (.+) times$/, '飞升$1次'],
    [/^Unlock (.+) mutations$/, '解锁$1种变异'],
    [/^Hatch (.+) swarmlings$/, '孵化$1单位跳虫'],
    [/^Hatch (.+) stingers$/, '孵化$1单位兵蜂'],
    [/^Hatch (.+) giant arachnomorphs$/, '孵化$1单位巨蜘蛛'],
    [/^Hatch (.+) arachnomorphs$/, '孵化$1单位蜘蛛'],
    [/^Hatch (.+) culicimorphs$/, '孵化$1单位飞蚊'],
    [/^Hatch (.+) locusts$/, '孵化$1单位蝗虫'],
    [/^Hatch (.+) roaches$/, '孵化$1单位蟑螂'],
    [/^Hatch (.+) chilopodomorphs$/, '孵化$1单位蜈蚣'],
