...
var cnRegReplace = new Map([
    ...
    [/^Grow (.+) hive empresses$/, '产生$1单位主巢女皇'],
    [/^Grow (.+) neuroprophets$/, '产生$1单位神经元先知'],
    [/^Grow (.+) hive neurons$/, '产生$1单位主巢神经元'],
    [/^Grow (.+) neural clusters$/, '产生$1单位神经元簇'],
    [/^Grow (.+) hive networks$/, '产生$1单位主巢网络'],
    [/^Grow (.+) lesser hive minds$/, '产生$1单位小主巢心智'],
    [/^Grow (.+) hive minds$/, '产生$1单位主巢心智'],
    [/^Grow (.+) arch-minds$/, '产生$1单位高级心智'],
    [/^Grow (.+) overminds$/, '产生$1单位主宰'],
    [/^Grow (.+) overmind IIs$/, '产生$1单位主宰 II'],
    [/^Grow (.+) overmind IIIs$/, '产生$1单位主宰 III'],
    [/^Grow (.+) overmind IVs$/, '产生$1单位主宰 IV'],
    [/^Grow (.+) overmind Vs$/, '产生$1单位主宰 V'],
    [/^Grow (.+) overmind VIs$/, '产生$1单位主宰 VI'],
    [/^Ascend (.+) times$/, '飞升$1次'],
